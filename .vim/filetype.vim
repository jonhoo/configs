augroup filetypedetect
  ...
  autocmd BufRead,BufNewFile /tmp/mutt* let g:neocomplete#enable_at_startup = 0
  autocmd Filetype tex let g:neocomplete#enable_at_startup = 0
  autocmd Filetype text let g:neocomplete#enable_at_startup = 0
  autocmd Filetype markdown let g:neocomplete#enable_at_startup = 0
augroup END
